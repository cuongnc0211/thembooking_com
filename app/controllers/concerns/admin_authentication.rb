module AdminAuthentication
  ...
  included do
    ...
    helper_method :admin_authenticated?, :current_staff
  end
  ...
  def after_admin_authentication_url
    session.delete(:admin_return_to) || admin_root_path
  end

  def start_admin_session_for(staff)
    staff.admin_sessions.create!(
